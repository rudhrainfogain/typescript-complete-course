...
var addresses = ["roop nagar kholi no", 420];
...
//------------------------------------
var addressTouple = ["roop nagar kholi no", 420];
...
(function (Color) {
    ...
    Color[Color["BLUE"] = 2] = "BLUE"; // BY DEFAULT 2
})(Color || (Color = {}));
...
(function (Fruits) {
    ...
    Fruits[Fruits["BANANA"] = 200] = "BANANA";
    Fruits[Fruits["MANGO"] = 201] = "MANGO";
    Fruits[Fruits["ORANGE"] = 7] = "ORANGE";
    Fruits[Fruits["GRAPES"] = 8] = "GRAPES"; //  AUTOMATICALLY INCREMENTS THE VALUE BEFORE IT SO BECOMES 8
})(Fruits || (Fruits = {}));
...
//# sourceMappingURL=basicSystemDefinedTypes.js.map